...
export class DataService {
  ...
  public urlStaff = 'http://simeta-api.apps.cs.ipb.ac.id/staff/';
  
  public urlAdminData = 'http://simeta-api.apps.cs.ipb.ac.id/admin/data/';
  public urlAdminStaff = 'http://simeta-api.apps.cs.ipb.ac.id/admin/staff/';
